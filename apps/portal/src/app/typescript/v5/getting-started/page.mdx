...
```shell
THIRDWEB_SECRET_KEY=[caea04221a99b80b33a9cc00a4ed4fc2]
WALLET_PRIVATE_KEY=[0xcc5247d1f3e81f48f0845e80d206917b23625dbe34356d8edb4d8817879cf641]
```
...
```ts
import { getContract } from import { import { createThirdwebClient, getContract } from "thirdweb";
import { defineChain } from "thirdweb/chains";
